"use strict";const t=(s,...c)=>s.map((v,p)=>`${v}${c[p]||""}`).join(""),l=t`#version 300 es
...
`;exports.ColorConversionUtils=o;exports.CommonUniforms=e;exports.HueCurveFragmentSource=f;exports.PassThroughVertexSource=l;exports.SaturationCurveFragmentSource=h;exports.ValueCurveFragmentSource=d;exports.glsl=t;
