...
function yv() {
  const e = [
    ...
    { path: "/colors", component: () => import("./colors-CDwguErv.mjs"), name: "colors" },
    { path: "/colors/create", component: () => import("./create-B0dKwdz-.mjs"), name: "color-create" },
    { path: "/colors/:token", component: () => import("./edit-db-saaK3.mjs"), name: "color-edit" },
    { path: "/settings", component: () => import("./settings-BXJk1KfK.mjs"), name: "settings" }
  ], t = Cm();
  return mv({
    history: t,
    routes: e
