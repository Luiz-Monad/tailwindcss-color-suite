"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } var _class; var _class2;// src/constants.ts
...
var Point = (_class = class _Point {
  __init() {this.x = 0}
  __init2() {this.y = 0}
  constructor(x_or_point_like, y) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);
...
var BezierCurve = (_class2 = class {
  __init3() {this.P1 = new Point(0, 0)}
  __init4() {this.P2 = new Point(0.5, 0.5)}
  __init5() {this.P3 = new Point(0.5, 0.5)}
  __init6() {this.P4 = new Point(1, 1)}
  constructor(points) {;_class2.prototype.__init3.call(this);_class2.prototype.__init4.call(this);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);
    this.P1 = points[0];
    this.P2 = points[1];
    this.P3 = points[2];
    this.P4 = points[3];
...
function samplePanelColorScale(color_scale, y) {
  let hue = (sampleComponentCurve(color_scale.hue_curve, y, 360) + (_nullishCoalesce(color_scale.hue_offset, () => ( 0)))) % 360;
...
exports.configToTailwindColors = configToTailwindColors; exports.tailwindColors = tailwindColors;
//# sourceMappingURL=plugin.tailwindcss.js.map